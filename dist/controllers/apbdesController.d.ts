...
export declare class ApbdesController {
    private apbdesService;
    constructor();
    ...
    getSummary(req: AuthenticatedRequest, res: Response): Promise<Response<any, Record<string, any>>>;
...
//# sourceMappingURL=apbdesController.d.ts.map