...
interface LembagaMasyarakatResponse {
  id: number;
  nama: string;
  deskripsi: string | null;
  ketua: string | null;
...
const formatLembagaMasyarakat = (
  lembaga: LembagaMasyarakat
): LembagaMasyarakatResponse => ({
  id: lembaga.id,
...
export class LembagaMasyarakatController {
  ...
  async create(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      const normalizedNoTelepon =
        noTelepon || no_telepon || nomorTelepon || phone;
